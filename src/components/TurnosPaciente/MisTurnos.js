...
import MyVerticallyCenteredModal from '../ModalVertical';
            ...
            {rows.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell style={{ fontSize:'20px', fontWeight:'bold'}} align="center">
                  <ToolTip title = "Cancelar Turno" placement="right" arrow>
                    <IconButton onClick={() => setModalShow(true)} title='Cancelar Turno' style={{color:'#000000'} }>
                      <CloseIcon></CloseIcon>
                    </IconButton>
                  </ToolTip>
                  </TableCell>
